                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        <div class="tile-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label" for="link2">Instagram Link </label>
                                                        <input class="form-control " type="url" name="link2" id="link2" placeholder="https://" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label" for="link3">Linkedin Link </label>
                                                        <input class="form-control " type="url" name="link3" id="link3" value="" placeholder="https://">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label" for="link4">Twitter Link </label>
                                                        <input class="form-control " type="url" name="link4" id="link4" value="" placeholder="https://">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">

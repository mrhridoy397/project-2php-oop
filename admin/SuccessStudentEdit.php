...
$data = $success->SuccessStudentedit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $success->SuccessStudentUpdate($_REQUEST);
// var_dump($value);
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="SuccessStudentIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                        <label for="student">Student Number<sup class="text-danger">*</sup></label>
                                            <input  type="number" name="student" id="student" class="form-control" placeholder="Student Number" value="<?php if(isset($_REQUEST['student']))  { echo $__REQUEST['student'];} else{echo $data['student'];}?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="SuccessStudentIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

...
$data = $CourseSelect->CourseSelectedit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $CourseSelect->CourseSelectUpdate($_REQUEST, $_FILES);
// var_dump($value);
?>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="buttonLink">Button Link<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="buttonLink" id="buttonLink" class="form-control" placeholder="Button Link" value="<?php if(isset($_REQUEST['buttonLink']))  { echo $__REQUEST['buttonLink'];} else{echo $data['buttonLink'];}?>">
                                        </div>
                                        <div class="form-group">

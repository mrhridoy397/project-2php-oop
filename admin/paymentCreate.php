...
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $payment->createPayment($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="paymentIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i> All Payment</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="paymentNumber">Payment Number<sup class="text-danger">*</sup></label>
                                            <input  type="number" name="paymentNumber" id="paymentNumber" class="form-control" placeholder="Payment Number" value="<?php if(isset($_REQUEST['paymentNumber']))  { echo $__REQUEST['paymentNumber'];}?>">
                                        </div>
                                        <div class="form-group">

...
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $freelancingimage->createfreelanchingImage($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="FreelanchingImageIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i> All Freelanching Image</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="ShortTitle">Short Title<sup class="text-danger">*</sup></label>
                                            <input  type="text" name="ShortTitle" id="ShortTitle" class="form-control" placeholder="Short Title" value="<?php if(isset($_REQUEST['ShortTitle']))  { echo $__REQUEST['ShortTitle'];}?>">
                                        </div>
                                        <div class="form-group">

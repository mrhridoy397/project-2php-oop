...
$data = $digitalMarketing->digitalMarketingedit($_REQUEST['id']);
$batch = $digitalMarketing->batch();
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $digitalMarketing->digitalMarketingUpdate($_REQUEST, $_FILES);
// var_dump($data);
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="digitalMarketingIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>

...
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $success->createSuccessStudent($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="SuccessStudentIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i> All Success Student</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="student">Student Number<sup class="text-danger">*</sup></label>
                                            <input  type="number" name="student" id="student" class="form-control" placeholder="Student Number" value="<?php if(isset($_REQUEST['student']))  { echo $__REQUEST['student'];}?>">
                                        </div>
                                        <div class="form-group">

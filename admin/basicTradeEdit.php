...
$data = $basicTrade->basicTradeedit($_REQUEST['id']);
$batch = $basicTrade->batch();
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $basicTrade->basicTradeUpdate($_REQUEST, $_FILES);
// var_dump($data);
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="basicTradeIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>

...
$data = $payment->Paymentdit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $payment->PaymentUpdate($_REQUEST, $_FILES);
// var_dump($value);
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="paymentIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="paymentNumber">Payment Number<sup class="text-danger">*</sup></label>
                                            <input  type="paymentNumber" name="paymentNumber" id="paymentNumber" class="form-control" placeholder="Payment Number" value="<?php if(isset($_REQUEST['paymentNumber']))  { echo $__REQUEST['paymentNumber'];} else{echo $data['paymentNumber'];}?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="paymentIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

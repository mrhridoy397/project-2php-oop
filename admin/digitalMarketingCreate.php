...
$batch = $digitalMarketing->batch();
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $digitalMarketing->createdigitalMarketing($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="digitalMarketingIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i> All DigitalMarketing Course</a>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <label for="description">Description</label>
                                          <textarea class="form-control" name="description" id="description" Rows="10" class="form-control"><?php if(isset($_REQUEST['description']))  { echo $__REQUEST['description'];}?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="digitalMarketingIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

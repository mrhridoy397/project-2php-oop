...
$Response = [];
$active = $About->active;
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $About->createAbout($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="AboutIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book-reader fa-sm text-white-50"></i> All About</a>
                    </div>
